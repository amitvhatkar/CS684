...
public class MedicineFragment extends Fragment   {
    ...
    Button btn_date,btn_time,btn_shedule;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_shedule=(Button)view.findViewById(R.id.btn_shedule);
        f1=new SimpleDateFormat("dd MMM yyyy", Locale.getDefault());
        f2=new SimpleDateFormat("hh:mm ", Locale.getDefault());
        try
        {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dpd=new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker arg0, int curr_year, int month, int day) {
                        ...
                        btn_date.setText(f1.format(cal.getTimeInMillis()));
        ...
        btn_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog tpd=new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    @Override
                    public void onTimeSet(TimePicker arg0, int h, int min) {
                        // TODO Auto-generated method stub
        ...
        btn_shedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    PendingIntent pdintent=PendingIntent.getActivity(getActivity(), 10, intent, PendingIntent.FLAG_UPDATE_CURRENT);
                    cal.set(Calendar.SECOND, 0);
                    alm.set(AlarmManager.RTC_WAKEUP, cal.getTimeInMillis(), pdintent);
